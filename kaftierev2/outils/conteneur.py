...
class ListK(list):
    def __init__(self,*arg,a='e'):  
        super(list, self).__init__(*arg)
        self._listConnection=[]
   
    def append(self,objet):
        super(list, self).append(objet)
        objet._listListK.append(self)
        
    def remove(self,objet):
        super(list, self).remove(objet)
        objet._listListK.remove(self)
                 
    def trier(self,tri_list_str=None):
        self.sort(key=attrgetter(tri_list_str))
                 
    def connectToModel(self,objet):
        self._listConnectionModel.append(objet)
        pass

    def disconnectToModel(self,objet):
        self._listConnectionModel.remouve(objet)
        pass
    
    def objetChanged(self):
        pass

    def objetDeleted(self):
        pass
    
    def objetAdded(self):
        pass
    
    def objetAdd(self,objet):
        self._list.append(objet)
        
        


class DictK:        
    def __init__(self,mere=None,type_objet=None):  
        self._dict={}
        self._mere=mere
    ...
    def connectTo(self,objet):
        self._listConnection.append(objet)
        pass

    def disconnectTo(self,objet):
        self._listConnection.remouve(objet)
        pass
        
    def __setitem__(self, key, objetK):        
        if key not in self._dict:
            self._dict.__setitem__(self, key, objetK)
